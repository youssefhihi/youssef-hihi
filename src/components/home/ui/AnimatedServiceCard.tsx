      ...
      <div className="flex flex-row flex-shrink-0 justify-center  items-center gap-2">
        {item.icons.map((icon, index) => (
            <IconContainer key={index}
                           className={`h-${index === 0 ? '8' : index === 1 || index === 3 ? '12' : '8'} w-${index === 0 ? '8' : index === 1 || index === 3 ? '12' : '8'} circle-${index + 1}`}>
              <Image
                  src={icon}
                  alt={`icon-${index + 1}`}
                  width={144}
                  ...
                  className={`h-${index === 0 || index === 4 ? '4' : index === 1 || index === 3 ? '6' : '8'} w-${index === 0 || index === 4 ? '4' : index === 1 || index === 3 ? '6' : '8'} aspect-square`}
              />
            </IconContainer>
        ))}
      </div>
