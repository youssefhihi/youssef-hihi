class Strings {
  ...
  static primaryEmail = "youssefhihi18@gmail.com";

  static buyMeACoffee = "BuyMeACoffee";
  static buyMeACoffeeLink = "https://buymeacoffee.com/youssefhihi";
  static buyMeACoffeeUsername = "youssefhihi";


  static fullName = "Youssef Hihi";
  static shortName = "youssefhihi";
}
